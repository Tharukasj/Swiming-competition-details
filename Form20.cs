...
namespace Swim
{
    public partial class Form20 : Form
    {
        ...
        public void display()
        {
            ...
            cmd.CommandText = "select * from PlaceDetails_3 order by Performance_Time asc";   // select all data
            cmd.ExecuteNonQuery();                     // execute the query
            System.Data.DataTable dt = new System.Data.DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
            grdPlace3.DataSource = dt;           // view data in gridview
            conn.Close();
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = System.Data.CommandType.Text;
            cmd.CommandText = "delete from PlaceDetails_3 where Admission_No = '" + txtAdmission.Text + "'";          // delete all data of each record using the Admission No
            cmd.ExecuteNonQuery();
            System.Data.DataTable dt = new System.Data.DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
            grdPlace3.DataSource = dt;
            conn.Close();
            display();
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = System.Data.CommandType.Text;
            cmd.CommandText = "select * from PlaceDetails_3 where Admission_No = '" + txtAdmission.Text + "' ";           // select row using admission No
            cmd.ExecuteNonQuery();
            System.Data.DataTable dt = new System.Data.DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
