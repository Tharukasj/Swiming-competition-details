...
namespace Swim
{
    public partial class Form30 : Form
    {
        ...
        public void display()
        {
            ...
            cmd.CommandText = "select * from PlaceDetailsRelay_3 order by Performance_Time asc";   // select all data in database
            cmd.ExecuteNonQuery();                     // execute the query
            System.Data.DataTable dt = new System.Data.DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
            grdRelay_3.DataSource = dt;           // view data in gridview
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = System.Data.CommandType.Text;
            cmd.CommandText = "select * from PlaceDetailsRelay_3 where Admission_No = '" + txtAdmission.Text + "' ";           // search recode using admission No
            cmd.ExecuteNonQuery();
            System.Data.DataTable dt = new System.Data.DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
            grdRelay_3.DataSource = dt;
            conn.Close();
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = System.Data.CommandType.Text;
            cmd.CommandText = "delete from PlaceDetailsRelay_3 where Admission_No = '" + txtAdmission.Text + "'";          // delete all data of each record using the Admission No
            cmd.ExecuteNonQuery();
            System.Data.DataTable dt = new System.Data.DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
