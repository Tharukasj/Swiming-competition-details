...
namespace Swim
{
    public partial class Form28 : Form
    {
        ...
        public void display()
        {
            ...
            cmd.CommandText = "select * from PlaceDetailsRelay_1 order by Performance_Time asc";   // select all data
            cmd.ExecuteNonQuery();                     // execute the query
            System.Data.DataTable dt = new System.Data.DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
            grdRelay_1.DataSource = dt;           // view data in gridview
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = System.Data.CommandType.Text;
            cmd.CommandText = "select * from PlaceDetailsRelay_1 where Admission_No = '" + txtAdmission.Text + "' ";           // search recorde using admission No
            cmd.ExecuteNonQuery();
            System.Data.DataTable dt = new System.Data.DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
            grdRelay_1.DataSource = dt;
            conn.Close();
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = System.Data.CommandType.Text;
            cmd.CommandText = "delete from PlaceDetailsRelay_1 where Admission_No = '" + txtAdmission.Text + "'";          // delete all data of each record using the Admission No
            cmd.ExecuteNonQuery();
            System.Data.DataTable dt = new System.Data.DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
